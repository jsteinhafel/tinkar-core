...
public class TinkarTerm {
    ...
    public static final EntityProxy.Concept HEALTH_CONCEPT =
            EntityProxy.Concept.make(" ", UUID.fromString("ee9ac5d2-a07c-3981-a57a-f7f26baf38d8"), UUID.fromString("a892950a-0847-300c-b477-4e3cbb945225"), UUID.fromString("f6daf03a-93d6-5bab-8dc9-f60c327cf012"));
    /**
